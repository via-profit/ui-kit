...
export interface SwitchErrorTextProps extends React.HTMLAttributes<HTMLSpanElement> {
...
const SwitchErrorText: React.ForwardRefRenderFunction<HTMLDivElement, SwitchErrorTextProps> = (
  props,
  ref,
) => {
...
export default React.forwardRef(SwitchErrorText);
