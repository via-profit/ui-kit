...
const Uknown: React.ForwardRefRenderFunction<SVGSVGElement, React.SVGProps<SVGSVGElement>> = (
  props,
  ref,
) => {
  ...
  return (
    ...
    >
      ...
      <path
        ...
        fill={color.textPrimary.toString()}
        strokeWidth=".72279"
      />
    </svg>
  );
...
export default React.forwardRef(Uknown);
