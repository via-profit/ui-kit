...
export interface CheckboxErrorTextProps extends React.HTMLAttributes<HTMLSpanElement> {
...
const CheckboxErrorText: React.ForwardRefRenderFunction<HTMLDivElement, CheckboxErrorTextProps> = (
  props,
  ref,
) => {
...
export default React.forwardRef(CheckboxErrorText);
