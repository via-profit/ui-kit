...
_При использовании темы значение цвета доступно как экземпляр класса [Color](../color/README.md):_
...
Все цвета внутри темы определены через класс [Color](../color/README.md).
