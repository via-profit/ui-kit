...
| **selectHighlightedItem** |                                          | Осуществляет выбор подсвеченного элемента. Будет вызван метод `onSelectItem`        |
| **highlightPrevItem**     |                                          | Прокручивает список до предыдущего элемента и подсвечивает его.                     |
| **highlightNextItem**     |                                          | Прокручивает список до следующего элемента и подсвечивает его.                      |
| **highlightFirstItem**    |                                          | Прокручивает список до первого элемента и подсвечивает его.                         |
| **highlightLastItem**     |                                          | Прокручивает список до последнего элемента и подсвечивает его.                      |
| **scrollToFirstSelected**  |                                          | Прокручивает список до первого выбранного элемента.                                 |
| **focus**                  |                                          | Устанавливает фокус на список.                                                      |
| **getListElement**         |                                          | Получает ссылку на HTML элемент списка (контейнер).                                 |
